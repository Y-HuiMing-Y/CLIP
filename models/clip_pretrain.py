...
class CLIP_Pretrain(nn.Module):
    def __init__(self, config,                
        ...
        # vit模块的更改,text_encoder更改为bert-base-uncased
        if vit=='base':
        ...
        self.tokenizer = BertTokenizer.from_pretrained('bert-base-uncased') #Download ‘bert-base-uncased’ in advance and save it to a local path 
