...
class CLIP_Pretrain(nn.Module):
    def __init__(self, config,                
        ...
        # vit模块的更改,text_encoder更改为bert-base-cased
        if vit=='base':
        ...
        self.tokenizer = BertTokenizer.from_pretrained('bert-base-cased') #Download ‘bert-base-cased’ in advance and save it to a local path 
        encoder_config = BertConfig.from_json_file(med_config)
        encoder_config.encoder_width = vision_width

        self.text_mlm_encoder = BertForMaskedLM.from_pretrained('bert-base-cased',config=encoder_config)
