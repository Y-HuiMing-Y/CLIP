...
class CLIP_Pretrain(nn.Module):
    def __init__(self, config,                
        ...
        self.tokenizer = BertTokenizer.from_pretrained('TurkuNLP/bert-base-finnish-cased-v1') #Download ‘bert-base-chinese’ in advance and save it to a local path 
        encoder_config = BertConfig.from_json_file(med_config)
        encoder_config.encoder_width = vision_width

        self.text_mlm_encoder = BertForMaskedLM.from_pretrained('TurkuNLP/bert-base-finnish-cased-v1',config=encoder_config)
